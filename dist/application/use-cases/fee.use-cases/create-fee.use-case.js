...
exports.CreateFeeUseCase = void 0;
const fee_service_1 = require("../../services/fee.service");
const inversify_1 = require("inversify");
let CreateFeeUseCase = class CreateFeeUseCase {
     ...
     */
    async execute(feeDto) {
        return this.feeService.createFee(feeDto);
    }
};
exports.CreateFeeUseCase = CreateFeeUseCase;
exports.CreateFeeUseCase = CreateFeeUseCase = __decorate([
