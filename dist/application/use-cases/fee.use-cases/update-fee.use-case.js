...
exports.UpdateFeeUseCase = void 0;
const fee_service_1 = require("../../services/fee.service");
const inversify_1 = require("inversify");
let UpdateFeeUseCase = class UpdateFeeUseCase {
     ...
     */
    async execute(id, fee) {
        return this.feeService.updateFee(id, fee);
    }
};
exports.UpdateFeeUseCase = UpdateFeeUseCase;
exports.UpdateFeeUseCase = UpdateFeeUseCase = __decorate([
