...
const transfer_to_entity_1 = require("../../helper/to.entity/transfer.to.entity");
const transfer_service_1 = require("../../services/transfer.service");
const inversify_1 = require("inversify");
let CreateTransferUseCase = class CreateTransferUseCase {
     ...
     */
    async execute(transferDto) {
        const transfer = (0, transfer_to_entity_1.toTransferEntity)(transferDto);
        return this.transferService.createTransfer(transfer);
    }
};
exports.CreateTransferUseCase = CreateTransferUseCase;
exports.CreateTransferUseCase = CreateTransferUseCase = __decorate([
